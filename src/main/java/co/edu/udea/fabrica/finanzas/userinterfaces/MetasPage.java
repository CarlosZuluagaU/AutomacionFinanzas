...
public class MetasPage {
    ...
    public static final Target GOAL_CARDS =
            Target.the("tarjetas de metas").locatedBy("[data-testid='goal-card'], .goal-card, article");

    public static final Target APORTE_INPUT =
            Target.the("campo aporte").locatedBy("input[placeholder*='porte'], input[type='number'][aria-label*='porte']");
    ...
    public static final Target PROGRESS_BAR =
            Target.the("barra de progreso").locatedBy("[role='progressbar'], .progress-bar, progress");

    public static final Target GOAL_NAMES =
            Target.the("nombres de metas").locatedBy("h3, .goal-name, [data-testid='goal-name']");
}
